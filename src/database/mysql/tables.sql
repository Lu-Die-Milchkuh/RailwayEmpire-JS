...
(
    ...
    FOREIGN KEY (assetIDFK) REFERENCES Asset (assetID)
);
...
(
    ...
    assetIDFK    INT,
    amount       INT NOT NULL,
    FOREIGN KEY (goodIDFK) REFERENCES Good (goodID),
    FOREIGN KEY (industryIDFK) REFERENCES Industry (industryID),
    FOREIGN KEY (assetIDFK) REFERENCES Asset (assetID)
);
...
(
    ...
    goodIDFK   INT NOT NULL,
    amount     INT NOT NULL,
    FOREIGN KEY (trainIDFK) REFERENCES Train (trainID),
    FOREIGN KEY (goodIDFK) REFERENCES Good (goodID)
);
